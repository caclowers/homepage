...
you might notice a small link called 'smirk' which, when clicked, will scroll the page all the way down to the bottom. there you will see a dashing gif of Ryan Reynolds flashing a smirk
...
i worked on the Woodland Pizza mobile app with UX Designer Olivia Klavetter. it is written with React Native

the PotatoHeadProject web app was a group effort with [Jimmy Brannon](https://github.com/brannonjames), [Paia Thao](https://github.com/paiathao), and [Toua Thao](https://github.com/TouaThao). it was written with a ReactJS front end and a MongoDB and NodeJS back end

SOL-Cycle was a solo project written in ReactJS and PostgreSQL/Node
