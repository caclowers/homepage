...
let images = [
  ...
  },
  {
    ...
    tag:
      "A wool blanket that i machine-knitted as a Christmas gift for my parents."
  },
  {
    image: bottles,
    info: "Cotton String - Crochet Hook",
    tag:
      "i collected a bunch of bottles and crocheted some string on them. They're pretty great."
  },
  {
    image: brasspins,
    info: "Brazing Rod - Hammer, Anvil",
    tag:
      'Saw something like these on Amazon and said to myself, "Self, you can make those." So i did. '
  },
  {
    image: coinring,
    info: "Coin - Hammer, Punch, Mandrel, Nylon Hammer",
    tag:
      "A Belizean $1 coin. The decagonal edge makes a great 'crown' effect when turned into a ring."
  },
  {
    image: costumes,
    info: "Fabric - Sewing Machine",
    tag:
      "First trip to the Minnesota Renaissance Festival. My friends were great sports. i made all of the costumes the day before"
  },
  {
    image: framebolsters,
    info: "Corner Brackets, Upholstery Tacks - Hammer",
    tag:
      "Bought the frame, but it needed ... something. i added the corner bolsters. Now it's right."
  }
];
